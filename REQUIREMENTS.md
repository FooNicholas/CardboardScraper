...
| Candidate store connectors | Planned — discovery and permission review | Add only after confirming a permitted, narrow exact-Japanese-serial lookup and the store's price/stock fields. Backlog: Hobby Station. Its public storefront loads normally; its Vanguard serial-search route and public price/stock fields still need to be inspected and validated before an offer can be displayed. |
